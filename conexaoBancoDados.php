...
// --- CÓDIGO ADICIONADO PARA A HERANÇA ---

// 1. Inclui a classe base do modelo.
require_once __DIR__ . '/model.php';

// 2. Injeta a conexão PDO ($gestor) na classe Model.
// Agora, a conexão está disponível para todas as classes que herdam de Model.
Model::setDatabase($gestor);
